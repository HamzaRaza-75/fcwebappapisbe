...
Route::middleware(['auth:sanctum', 'role:super-admin|team-captain|bussiness-development-manager|team-leader|human-resources'])->group(function () {
...
Route::middleware(['auth:sanctum', 'role:super-admin|team-captain'])->group(function () {
...
Route::middleware(['auth:sanctum', 'role:super-admin|team-captain|bussiness-administration-manager'])->group(function () {
    Route::post('/accept-team-request/{id}', [TeamrequestController::class, 'store'])->name('teamrequest.store');
    Route::get('/reject-team-request/{id}', [TeamrequestController::class, 'rejectteamrequest'])->name('teamrequest.rejectteamrequest');
